// Flat C exports observed in StartTileData.dll. Unknown ABIs are intentionally not declared.
// Validated dialects: ISO C17/C23/C26 draft and Windissect C20 (C ABI under C++20).
#pragma once
#ifndef STARTTILEDATA_C_H
#define STARTTILEDATA_C_H
...
// Export: HasMigratedTDLData (ABI unverified)
// Export: DllGetClassObject (ABI unverified)
// Export: DllGetActivationFactory (ABI unverified)
// Export: GetSetting (ABI unverified)
// Export: ProcessStartLayoutPolicy (ABI unverified)
// Export: TryMigrateTDLData (ABI unverified)

#ifdef __cplusplus
} // extern "C"
#endif
#endif // STARTTILEDATA_C_H
