//! Windissect-generated Rust FFI bindings for StartTileData.dll. Windows only.
...
pub const EXPECTED_PDB_GUID: &str = "FE7C28895409E34E881F63B6AD9D629F";
pub const EXPECTED_PDB_AGE: u32 = 1;
pub const EXPECTED_PE_TIMESTAMP: u32 = 3539558965;
...
mod resolver {
    ...
    pub fn base() -> usize {
        ...
        let name: [u16; 18] = [83, 116, 97, 114, 116, 84, 105, 108, 101, 68, 97, 116, 97, 46, 100, 108, 108, 0];
        ...
        if live_timestamp != 3539558965 { return 0; }
